...
class SaveTimeLogRequest extends FormRequest
{
    /**
    ...
    /**
     * Get the validation rules that apply to the request. A manual entry
     * always carries both ends — an in-progress entry with no `ended_at`
     * only ever comes from the dedicated start/stop timer routes, never
     * this general-purpose form.
     *
