...
class AlpRtmImportSeeder extends Seeder
{
     ...
     * @param  \Illuminate\Support\Collection<string, int>  $scopeIds
     */
     ...
     * @param  \Illuminate\Support\Collection<string, int>  $taskTypeIds
